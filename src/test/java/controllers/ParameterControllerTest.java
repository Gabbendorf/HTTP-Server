...
public class ParameterControllerTest {
    ...
    public void respondsWithDecodedQueryStringInBody() {
        ...
        HTTPPath pathWithQueryString = new HTTPPath("/parameters?variable_1=Operators%20%3C%2C%20%3E%2C%20%3D%2C%20!%3D%3B%20%2B%2C%20-%2C%20*%2C%20%" +
    ...
    public void throwsNotSupportedEncodingException() {
        ...
        parameterControllerWithException.get(new HTTPRequest(GET.method, new HTTPPath("/")));
    }
}
