...
public class Configuration {
    ...
    public Map<String, Controller> setControllers(Logger logger, String directory) {
        ...
        controllers.put("/file1", new FilePage(new FileSystem(directory)));
        controllers.put("/text-file.txt", new FilePage(new FileSystem(directory)));
        controllers.put("/coffee", new TeaPage());
        controllers.put("/tea", new TeaPage());
        controllers.put("/patch-content.txt", new FilePage(new FileSystem(directory)));
        return controllers;
    }
}
